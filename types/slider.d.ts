...
export interface SliderOptions {
    ...
    Description?: string;                   // The description of the slider, what it's about.
    Default: number;                        // The default (starting) value for the slider. (min through max)
    Min: number;                            // The minimum value for the slider.
    Max: number;                            //     maximum
    Rounding?: number;                      // Where the decimal is placed. (Lua index starts at 1)
